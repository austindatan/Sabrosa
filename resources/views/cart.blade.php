  ...
  <main class="flex-1 px-4 py-6 sm:p-8 text-left max-w-6xl mx-auto text-base sm:text-lg mt-[79px] sm:mt-[200px] mb-[0px] sm:mb-[150px] bg-white border-2 border-[#E55182] rounded-lg shadow-lg">
    ...
    @if ($cartItems->isEmpty())
      ...
      <div class="text-center">
        <a href="{{ route('shop') }}" class="bg-pink-500 hover:bg-pink-600 text-white px-6 py-2 rounded text-sm">Start Shopping</a>
      </div>
    @else
      ...
      <div class="flex justify-end mt-4">
        <a href="{{ route('checkout') }}" class="inline-block bg-pink-500 hover:bg-pink-600 text-white font-semibold text-sm px-6 py-2 rounded transition duration-200">
