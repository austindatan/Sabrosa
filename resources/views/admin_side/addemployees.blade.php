...
<body class="bg-pink-50">
  <div class="app min-h-screen flex flex-col md:flex-row">
    ...
    <main class="flex-1 text-[#E55182] px-4 py-6 sm:p-8 text-left max-w-6xl mx-auto text-base sm:text-lg mt-[20px] mb-[20px] bg-white border-2 border-[#E55182] rounded-lg shadow-lg md:ml-[calc(21%+1rem)]">
    ...
    <div class="mb-5 flex flex-row gap-4">
      <div class="flex flex-col w-1/3">
        ...
        <input id="firstName" name="firstName" required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" placeholder="Enter first name">
      </div>

      <div class="flex flex-col w-1/3">
        <label for="middleName" class="font-semibold mb-2 font-poppins">Middle Name</label>
        <input id="middleName" name="middleName" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" placeholder="Enter middle name">
      </div>
      ...
      <div class="flex flex-col w-1/3">
        ...
        <input id="lastName" name="lastName" required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" placeholder="Enter last name">
      </div>
    </div>
        ...
        <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div class="flex flex-col">
            ...
            <input id="street" name="street" placeholder="Enter street" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" />
          </div>
          ...
          <div class="flex flex-col relative">
            ...
            <input id="city" name="city" required placeholder="Enter city" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" />
          </div>
          ...
          <div class="flex flex-col relative">
            ...
            <input id="province" name="province"  placeholder="Enter province"  required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" />
          </div>
          ...
          <div class="flex flex-col relative">
            ...
            <input id="country" name="country" required placeholder="Enter country" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]" />
          </div>
        </div>
      ...
      <div class="mb-5 flex flex-col mb-16">
        ...
        <select id="employee_positions_id" name="employee_positions_id" required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
