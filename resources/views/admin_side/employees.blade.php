          ...
          <table class="w-full table-fixed text-sm text-left text-pink-900">
            ...
            <tbody>
              ...
              @foreach($employees as $employee)
                <tr class="bg-white border-b border-pink-200 hover:bg-pink-50">
                      <td class="px-4 py-4 truncate">{{ $employee->employee->firstname ?? 'N/A' }}</td>
                      <td class="px-4 py-4 truncate">{{ $employee->employee_account->email ?? 'N/A' }}</td>
                      <td class="px-4 py-4 truncate">{{ $employee->employee->lastname ?? 'N/A' }}</td>
