...
<div class="app min-h-screen flex flex-col md:flex-row">
  ...
  <main class="flex-1 px-4 py-6 sm:p-8 text-left max-w-6xl mx-auto text-base sm:text-lg mt-[20px] mb-[20px] bg-white border-2 border-[#E55182] rounded-lg shadow-lg md:ml-[calc(21%+1rem)]">
    ...
    <div class="flex justify-between items-center mb-4 gap-24">
      <h2 class="text-2xl font-bold text-[#E55182] text-right font-poppins">Add Product</h2>
    </div>

    <form id="addProductForm" method="POST" action="{{ route('admin.storeProduct') }}" enctype="multipart/form-data">
      @csrf
      <div class="mb-8">
        <h3 class="text-xl font-semibold mb-4 text-[#E55182] font-poppins">Product Images</h3>
        <div class="flex flex-col md:flex-row gap-4 mb-6">

          <!-- Product Photo 1 -->
          <div class="relative group w-full md:w-1/2 h-32 border-2 border-dashed border-[#E55182] rounded-lg bg-white overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div class="text-center text-[#E55182] font-poppins text-sm">
            ...
            <img id="productPhotoPreview1" src="{{ asset('images/transparent.png') }}" alt="Product Photo 1" class="w-full h-full object-cover pointer-events-auto cursor-pointer" onclick="showModal(this.src)">
          ...
          <div class="relative group w-full md:w-1/2 h-32 border-2 border-dashed border-[#E55182] rounded-lg bg-white overflow-hidden">
            ...
            <img id="productPhotoPreview2" src="{{ asset('images/transparent.png') }}" alt="Product Photo 2" class="w-full h-full object-cover pointer-events-auto cursor-pointer" onclick="showModal(this.src)">
      ...
      <div class="mb-5 flex flex-col text-[#E55182]">
        <label for="productName" class="font-semibold mb-2 font-poppins">Product Name</label>
        <input id="productName" name="productName" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
      </div>

      <div class="mb-5 flex flex-col text-[#E55182]">
        <label for="store_id" class="font-semibold mb-2 font-poppins">Brand <span class="text-red-500">*</span></label>
        <select id="store_id" name="store_id" required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
        ...
        <div class="mb-5 flex flex-col mt-4">
          ...
          <select id="category_id" name="category_id" required class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
      ...
      <div class="mb-5 flex flex-col text-[#E55182]">
        ...
        <textarea id="productDescription" name="productDescription" rows="4" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]"></textarea>
      </div>

      <div class="mb-5 flex flex-col text-[#E55182]">
        <label for="productWeight" class="font-semibold mb-2 font-poppins">Weight (kg)</label>
        <input type="number" id="productWeight" name="productWeight" step="0.01" class="font-dm-sans p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
      </div>
      
      <div class="flex flex-row gap-5 text-[#E55182]">
        <div class="mb-5">
          <label class="font-semibold mb-2 block font-poppins">Price <span class="text-red-500">*</span></label>
          <div class="flex flex-wrap items-center gap-5">
            <div class="flex gap-2">
              <div class="flex items-center border border-[#E55182] rounded-lg p-2.5 text-sm bg-white text-[#4d2c3d]">
                <span class="text-xl">₱</span>
              </div>
              <input type="number" id="productPrice" name="productPrice" required class="p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
            </div>
            ...
            <div class="flex items-center gap-3">
              <label class="relative inline-block w-[50px] h-[26px]">
                ...
                <span class="absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-[#E55182] rounded-full transition peer-checked:bg-[#f8c9d8]"></span>
        ...
        <div class="mb-5 flex flex-col">
          ...
          <input type="number" id="stockQuantity" name="stockQuantity" min="0" class="p-2.5 border border-[#E55182] rounded-lg text-sm bg-white text-[#4d2c3d] focus:outline-none focus:border-[#f8c9d8]">
        </div>
      </div>

      <button type="button" id="addProductBtn" class="mt-5 font-poppins bg-[#f8c9d8] hover:bg-[#e4a6b8] text-white px-6 py-3 text-base rounded-lg font-medium transition-colors">
        Add Product
      </button>
    </form>
  </main>
