  ...
  <main class="flex-1">
    <div class="flex flex-col lg:flex-row gap-10 px-10 py-10 max-w-[1440px] mx-auto mt-[100px]">
      <div class="flex-1 flex flex-col gap-4">
          <img src="{{ asset('images/product/product display/Tropical Mango & Passionfruit Cookie.png') }}" className="h-[450px] object-contain">
      </div>
      ...
      <div class="flex-1 flex flex-col gap-2">
        ...
        <div class="flex justify-between items-stretch w-full mt-4 gap-4">
          <div class="flex-1">
            ...
            Tropical Mango & Passionfruit Cookie
            </h2>
          </div>
        ...
        <div className="gap-16">
          ...
          <p class="text-gray-700 leading-relaxed font-dm-sans text-justify">
          Escape to the tropics with flavours of coconut coupled with mango and passionfruit jellies.</p>
          <p class="text-gray-700 leading-relaxed font-dm-sans text-justify">
          Individually wrapped for convenience, each Byron Bay Wrapped Cafe Cookie delivers a taste of Byron in every bite.</p>
          <p class="text-gray-700 leading-relaxed font-dm-sans text-justify">Available as an individually wrapped 55g cookie or as a dozen individually wrapped 55g cookies in a cookie box. Featuring unique artwork from Australian artist Chloe Joyce. </p>
          <p class="text-gray-700 leading-relaxed font-dm-sans text-justify">Designed with cafes in mind, the Byron Bay Cookie display box is your ultimate cookie stash! Showcase your cookies at home or at work, and wherever else cookie cravings may arise.</p>
        </div>
        <div class="mt-10">
