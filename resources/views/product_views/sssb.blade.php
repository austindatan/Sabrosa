    ...
    <div class="flex flex-col lg:flex-row gap-10 px-10 py-10 max-w-[1440px] mx-auto mt-[100px]">
      ...
      <div class="flex-1 flex flex-col gap-2">
        ...
        <div>
          ...
          Compartés Strawberry Shortcake white chocolate bar, is packed full of strawberries and chunks of airy homemade shortcake. It's a chocolate bar that tastes like absolute heaven in every bite! Wrapped up in Compartés hand-drawn strawberry graphics. Handmade in our Los Angeles chocolate kitchens.        </div>

        <div>
          <h3 class="text-lg font-semibold mt-4 mb-2 italic text-left font-dm-sans">Ingredients</h3>
          <p class="text-gray-700 text-sm font-dm-sans text-justify">
          White Chocolate (Sugar, Cocoa Butter, Whole Milk, Soy Lecithin [Emulsifier], Natural Vanilla), Freeze-Dried Strawberries, Homemade Shortcake (Wheat Flour, Creamery Butter, Cane Sugar, Wheat Starch, Sea Salt), Natural Flavors.</p>
        </div>
