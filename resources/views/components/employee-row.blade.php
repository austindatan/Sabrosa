<tr class="bg-white border-b border-pink-200 hover:bg-pink-50">
    <td class="px-4 py-4 truncate text-pink-900 flex items-center gap-2">{{ $name }}</td>
    <td class="px-4 py-4 truncate">{{ $email }}/td>
    <td class="px-4 py-4 truncate">{{ $number }}</td>
    <td class="px-4 py-4 truncate">{{ $position }}</td>
